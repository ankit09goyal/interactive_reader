...
/**
 * DeleteModal - Reusable delete confirmation modal component
 *
 * @param {Object} props
 * @param {string} props.title - Modal title (e.g., "Delete Book", "Delete Question")
 * @param {React.ReactNode} props.itemPreview - JSX to display item preview/details
 * @param {string} props.warningMessage - Warning message to display
 * @param {string} props.confirmButtonText - Text for the confirm/delete button
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        {/* Item Preview */}
        {itemPreview && (
          <div className="bg-base-200 rounded-lg p-4 mb-4">{itemPreview}</div>
        )}
